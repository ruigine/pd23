    ...
    <div>
        <v-form v-model="valid" ref="form">
            <v-row class="box" align="center">
                <v-col cols="12">
                    <h1 class="mb-12">Hourly Drop Redemption</h1>
                    <v-text-field
                        v-model="name"
                        color="#000"
                        :rules="nameRules"
...
<script>
    ...
    export default {
        data(){
            return {
                ...
                teleRules: [
                    ...
                    s => (!this.teleList.includes(s) || 'Already redeemed')
                ],
                prevSNo: [],
                sNo: [],
                sNos: [],
        ...
        created(){
            ...
            const hRef = collection(db, 'hourlyDrop');
            onSnapshot(hRef, (snapshot) => {
            var t = [];
            snapshot.docs.forEach((doc) => {
